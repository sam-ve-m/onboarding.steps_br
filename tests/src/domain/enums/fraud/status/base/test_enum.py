...
def test_relation_with_approved_and_pending():
    ...
    assert (
        OnboardingFraudStatusEnum.APPROVED > OnboardingFraudStatusEnum.PENDING
    ) is False
    assert (
        OnboardingFraudStatusEnum.PENDING < OnboardingFraudStatusEnum.APPROVED
    ) is False
...
def test_relation_with_reproved_and_pending():
    ...
    assert (
        OnboardingFraudStatusEnum.PENDING > OnboardingFraudStatusEnum.REPROVED
    ) is False
    assert (
        OnboardingFraudStatusEnum.REPROVED < OnboardingFraudStatusEnum.PENDING
    ) is False


def test_relation_with_equals():
    assert (
        OnboardingFraudStatusEnum.REPROVED < OnboardingFraudStatusEnum.REPROVED
    ) is False
    assert (
        OnboardingFraudStatusEnum.REPROVED > OnboardingFraudStatusEnum.REPROVED
    ) is False
    ...
    assert (
        OnboardingFraudStatusEnum.APPROVED < OnboardingFraudStatusEnum.APPROVED
    ) is False
    assert (
        OnboardingFraudStatusEnum.APPROVED > OnboardingFraudStatusEnum.APPROVED
    ) is False
    ...
    assert (
        OnboardingFraudStatusEnum.PENDING < OnboardingFraudStatusEnum.PENDING
    ) is False
    assert (
        OnboardingFraudStatusEnum.PENDING > OnboardingFraudStatusEnum.PENDING
    ) is False
